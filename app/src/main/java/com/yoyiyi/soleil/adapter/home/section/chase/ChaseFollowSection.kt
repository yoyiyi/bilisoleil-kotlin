 ...
 * * 描述:首页直播推荐主播section
 */
class ChaseFollowSection(private val mCount: String, private val mList: List<ChaseBangumi.Follows>) : StatelessSection<Nothing>(R.layout.layout_item_home_chase_head, R.layout.layout_item_home_chase_body) {
