 ...
 * * 描述:
 */
class RegionRecommendEntranceSection(private val mTid: Int) : StatelessSection<*>(R.layout.layout_item_region_recommend_entrance, R.layout.layout_empty) {
    ...
    private fun init() {
        when (mTid) {
            13//番剧
            -> mList = Arrays.asList(RegionEnter("连载动画", R.mipmap.ic_category_t33),
            ...
            1//动画
            -> mList = Arrays.asList(RegionEnter("MAD·AMV", R.mipmap.ic_category_t24),
            ...
            3//音乐
            -> mList = Arrays.asList(RegionEnter("翻唱", R.mipmap.ic_category_t31),
            ...
            129//舞蹈
            -> mList = Arrays.asList(RegionEnter("宅舞", R.mipmap.ic_category_t20),
                    RegionEnter("三次元舞蹈", R.mipmap.ic_category_t154),
                    RegionEnter("舞蹈教程", R.mipmap.ic_category_t156))
            4//游戏
            -> mList = Arrays.asList(RegionEnter("单机联机", R.mipmap.ic_category_t17),
            ...
            36//科技
            -> mList = Arrays.asList(RegionEnter("纪录片", R.mipmap.ic_category_t37),
            ...
            160//生活
            -> mList = Arrays.asList(RegionEnter("搞笑", R.mipmap.ic_category_t138),
            ...
            119//鬼畜
            -> mList = Arrays.asList(RegionEnter("鬼畜调教", R.mipmap.ic_category_t22),
            ...
            11//电视剧
            -> mList = Arrays.asList(RegionEnter("连载剧集", R.mipmap.ic_category_t15),
